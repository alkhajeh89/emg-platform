...
| ADR-028 | Audit Reconciliation | **Draft — authorizes no implementation.** Revision 1 is written and merged with `Decision Date: TBD`. Not Accepted. No consumer of the `mutation_dispatch` `audit` channel exists. Registered 2026-08-03 |
